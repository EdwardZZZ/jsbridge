...
const OS_NAME = config.OS_NAME // 推荐替换成公司标识，如淘宝“TaobaoCN”
const API_ROOT = config.API_ROOT
const SCHEMA = config.SCHEMA
const WEB_CB_SN_PREFIX = config.WEB_CB_SN_PREFIX
const REQ_SN_KEY = config.REQ_SN_KEY
const RES_SN_KEY = config.RES_SN_KEY
